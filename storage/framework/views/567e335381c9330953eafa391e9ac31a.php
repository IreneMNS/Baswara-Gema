    ...
    <div class="col-xl-4 col-md-6 mb-4">
        <div class="card bg-success text-white shadow h-100">
            <div class="card-body">
                ...
                <h3 class="mt-2">Rp <?php echo e(number_format($pendapatan ?? 12500000, 0, ',', '.')); ?></h3>
            </div>
    ...
    <div class="col-xl-4 col-md-6 mb-4">
        <div class="card bg-warning text-white shadow h-100">
            <div class="card-body">
                ...
                <h3 class="mt-2"><?php echo e($pengunjung ?? 328); ?> Orang</h3>
            </div>
            <div class="card-footer d-flex justify-content-between align-items-center">
...
<script>
    ...
    const chartData = <?php echo json_encode($dataReservasi ?? [12, 19, 8, 15, 22, 30, 25, 18, 20, 27, 21, 31]); ?>;
...
<?php echo $__env->make('dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\admusik\resources\views/dashboard/index.blade.php ENDPATH**/ ?>